...
if submitted:
    ...
    fig.update_layout(
        polar=dict(
            ...
            radialaxis=dict(visible=True, range=[0, 25], showline=True, linewidth=1, gridcolor="lightgrey", gridwidth=0.5, tickfont=dict(size=10)),
            angularaxis=dict(tickfont=dict(size=10), gridcolor="lightgrey", gridwidth=0.5)
        ),
        showlegend=True,
        legend=dict(title="Persona", orientation="h", yanchor="bottom", y=-0.3, xanchor="center", x=0.5),
